...
```bash
# Pull
sudo nerdctl pull quay.io/jaegertracing/jaeger-operator:1.65.0

# Tag
sudo nerdctl tag quay.io/jaegertracing/jaeger-operator:1.65.0 repository.dev.eris.go.kr/my-docker-image/jaeger-operator:1.65.0

# Login
sudo nerdctl login repository.dev.eris.go.kr

# Push
sudo nerdctl push repository.dev.eris.go.kr/my-docker-image/jaeger-operator:1.65.0
```

**NodePort 방식은 `--plain-http` 옵션 필수:**
