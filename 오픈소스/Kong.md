...
- [Kong Kubernetes 통합](https://docs.konghq.com/kubernetes-ingress-controller/)
- [Konga 프로젝트](https://github.com/pantsel/konga)
- [Kong 플러그인 허브](https://docs.konghq.com/hub/)
- [Kong Admin API 레퍼런스](https://docs.konghq.com/gateway/latest/admin-api/)

---

**Tags:** #kong #apigateway #kubernetes #nginx #microservices #konga #ingress #postgresql #lua